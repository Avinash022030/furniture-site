...
function ContactForm() {
  ...
  let [formData2, setFromData2] = useState({ lastName: "Avinash" })
  let [formData3, setFromData3] = useState({ email: "avinash@gmail.com" })
  let [formData4, setFromData4] = useState({ message: "Avinash hello" })
